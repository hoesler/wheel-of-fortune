define(["../source/scripts/helper/math"], function(math) {
	QUnit.module("math.js");

	QUnit.test("roulette_wheel_selection rand min", function( assert ) {
		var index = math.roulette_wheel_selection([0.1, 0.1, 0.1], {random: function() { return 0; }});
	...
	QUnit.test("roulette_wheel_selection rand max", function( assert ) {
		var index = math.roulette_wheel_selection([0.1, 0.1, 0.1], {random: function() { return 0.999999999; }});
